...
2. As this is Mavenized  project run coomand "mvn clean install". This will also run all the test cases.
3. The executable jar with name PizzaOrder will be created in target folder
4. Run the Application by executing jar with the below coomand
...
NOTE: --file.source and file.destination path will be your loacl system path.

The above command deploy the Spring boot application on inbuild tomcat server on port 8080
